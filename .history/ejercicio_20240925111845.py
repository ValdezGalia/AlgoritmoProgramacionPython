...
def main():
    ...
    print( Fore.RED + "Indique numero 1 entero positivo : ")
    n1 = int(input())
    
    print( Fore.RED + "Indique numero 2 entero positivo : ")
    n2 = int(input())
    
    print( Fore.RED + "Indique numero 3 entero positivo : ")
    n3 = int(input())
    
    print( Fore.RED + "Indique numero 4 entero positivo : ")
    n4 = int(input())

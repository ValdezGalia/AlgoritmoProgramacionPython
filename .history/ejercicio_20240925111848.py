...
def main():
    ...
    print( Fore.RED + "Indique numero 1 entero positivo del 100: ")
    n1 = int(input())
    
    print( Fore.RED + "Indique numero 2 entero positivo del 100: ")
    n2 = int(input())
    
    print( Fore.RED + "Indique numero 3 entero positivo del 100: ")
    n3 = int(input())
    
    print( Fore.RED + "Indique numero 4 entero positivo del 100: ")
    n4 = int(input())
